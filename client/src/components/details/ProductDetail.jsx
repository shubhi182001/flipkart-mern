  ...
  return (
    <>
      ...
      <SmallText>
        ...
        <Typography><StyledBadge/> Get extra 1% off (price inclusive of discount) T&C</Typography>
        <Typography><StyledBadge/> Sign up for Flipkart Pay Later and get Flipkart Gift Card worth ₹100* Know More </Typography>
        <Typography><StyledBadge/> Get extra 20% off on 1 item(s) T&C</Typography>
        <Typography><StyledBadge/> Get extra 1% off (price inclusive of discount) T&C</Typography>
      </SmallText>
      <Table>
        <TableBody>
            ...
            <ColumnText>
                ...
                <TableCell >
                    <Box component="span" style={{color:"#2874f0"}}>SuperComent</Box>
